...
from PyQt5.QtWidgets import QAction, QMainWindow, QApplication, QPushButton, QMenu, QFileDialog, QLabel, QWidget
...
class SnippingWidget(QtWidgets.QWidget):
    ...
    def mouseReleaseEvent(self, event):
        ...
        # print(f"{x1}-{y1}>>>>{x2}-{y2}")
        img = ImageGrab.grab(bbox=(x1, y1+33, x2, y2+40))
        QtWidgets.QApplication.processEvents()
...
def open_window():
    app = QApplication([])
    widnow = QWidget(windowTitle="hello qt")
    widnow.show()
    app.exec()
